...
function nmdrTable(id) {
    ...
    $.makeView = function () {
		...
		style = "<style type='text/css'>" +
            ...
            pfx + " .nmdrTB_header_th_dv:hover { cursor: pointer; }" +
            ...
            pfx + " .nmdrTB_header_th_rdv { width:4px; cursor: col-resize; }" +
    ...
    $.makeHeader = function () {
        ...
        for (var col = 0; col < this.columns.length; col++) {
			...
			var cw = this.getColumnWidth(col),
				...
				rz = this.props.columnsResizable ? ("<td class='nmdrTB_header_th_rdv' " +
			...
			buf.push("<td style='padding:0px 0px 0px 0px;'><div class='nmdrTB_header_th_dv' onClick=\"nmdr.core.$('" + this.id + "').sortColumn(" + col + ");\">" + (ct ? ct : this.columns[col]) + "</div></td>");
			buf.push("<td style='width:52px; padding:0px 0px 0px 0px;'><table border='0' cellpadding='0' cellspacing='0'><tr>");
			buf.push("<td style='width:16px; padding:0px 0px 0px 0px;'>" + s1 + "</td>");
			buf.push("<td style='width:16px; padding:0px 0px 0px 0px;'>" + s2 + "</td>");
			buf.push("<td style='width:16px; padding:0px 0px 0px 0px; text-align:right;'>");
	...
	$.resizeColumn = function (e, mode, col) {
		if (mode == 0) {
			this.props.pageX = e.pageX; 
			...
			var diffX = e.pageX - this.props.pageX;
